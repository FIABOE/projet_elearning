  ...
  if (_isFormValid) {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Afficher le dialogue de réussite
        _showSuccessDialog();
      } else if (response.statusCode == 400) {
        // Gérer l'erreur d'inscription existante
        _showExistingAccountErrorDialog();
      } else {
...
void _showSuccessDialog() {
  // Afficher le dialogue de réussite ici
  showDialog(
    context: context,
    builder: (context) {
      return AlertDialog(
...
void _showExistingAccountErrorDialog() {
  // Afficher le dialogue d'erreur pour un compte existant
  showDialog(
    context: context,
    builder: (context) {
      return AlertDialog(
...
void _showErrorDialog(String errorText) {
  // Afficher le dialogue d'erreur avec le texte d'erreur spécifié
  showDialog(
    context: context,
    builder: (context) {
      return AlertDialog(
...
void _handleError(dynamic error) {
  // Gérer l'erreur ici
  print('Erreur : $error');
  // Ajoutez ici le code pour gérer l'erreur selon vos besoins
}
}
