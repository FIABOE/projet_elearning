...
class CoursStatisticsPage extends StatefulWidget {
  const CoursStatisticsPage({super.key});

  @override
  _CoursStatisticsPageState createState() => _CoursStatisticsPageState();
}

class _CoursStatisticsPageState extends State<CoursStatisticsPage> {
