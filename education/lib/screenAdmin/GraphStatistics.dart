...
class GraphStatisticsPage extends StatefulWidget {
  const GraphStatisticsPage({super.key});

  @override
  _GraphStatisticsPageState createState() => _GraphStatisticsPageState();
}

class _GraphStatisticsPageState extends State<GraphStatisticsPage> {
