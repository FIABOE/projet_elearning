...
class Add_ModExercices extends StatefulWidget {
  const Add_ModExercices({super.key});

  @override
  _Add_ModExercicesState createState() => _Add_ModExercicesState();
}

class _Add_ModExercicesState extends State<Add_ModExercices> {
          ...
          TextButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const ListeExercices(),
                ),
              );
            },
            child: const Row(
